...
public class UnityMessageEvent : MonoBehaviour //메세지를 받는 기능을 포함하고 잇음 모노
{
    /************************************************************************
	 * 유니티메시지 이벤트함수
	 * 
    ...
    private void Awake() //준비가 안 된 상태에서
    {
    ...
    private void Start() //모든 오브젝트가 준비된 상태에서
    {
    ...
    private void OnDisable() //게임이 마무리
    {
        // 스크립트가 비활성화될 때마다 호출
    ...
    private void OnDestroy() //컴포넌트가 지워졌을 때
    {
        // 스크립트가 삭제되었을 경우 호출
